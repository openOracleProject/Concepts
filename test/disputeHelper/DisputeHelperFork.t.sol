...
contract DisputeHelperForkTest is Test {
    ...
    address constant ORACLE = 0xf3CCE3274c32f1F344Ba48336D5EFF34dc6E145f;
    ...
    function setUp() public {
        // Fork Base mainnet
        vm.createSelectFork("https://base-rpc.publicnode.com", 43225333);
    ...
    function _createWethUsdcReport(
        ...
        IOpenOracle.CreateReportParams memory params = IOpenOracle.CreateReportParams({
            exactToken1Report: exactToken1,
            escalationHalt: type(uint256).max,
    ...
    function _submitInitialReport(
        ...
        oracle.submitInitialReport(reportId, amount1, amount2, stateHash, alice);
        vm.stopPrank();
    }
    ...
    function test_happyPath_disputeWithSufficientTokens() public {
        ...
        assertTrue(newStatus.disputeOccurred, "dispute should have occurred");
    ...
    function test_fullLifecycle_disputeThenSettle() public {
        ...
        vm.prank(alice);
        (uint256 price, uint256 settlementTs) = oracle.settle(reportId);
