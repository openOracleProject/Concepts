...
contract OpenSwapCancellationTest is Test {
    ...
    function _createSwap() internal returns (uint256 swapId) {
        ...
        openSwapOPGrant.OracleParams memory oracleParams = openSwapOPGrant.OracleParams({
        ...
        openSwapOPGrant.SlippageParams memory slippageParams = openSwapOPGrant.SlippageParams({
            priceTolerated: 5e14,
            toleranceRange: 1e7 - 1
        });

        openSwapOPGrant.FulfillFeeParams memory fulfillFeeParams = openSwapOPGrant.FulfillFeeParams({
        ...
        openSwapOPGrant.BountyParams memory bountyParams = openSwapOPGrant.BountyParams({
    ...
    function testCancelSwap_FailsIfNotSwapper() public {
        ...
        vm.prank(randomUser);
        vm.expectRevert(abi.encodeWithSelector(openSwapOPGrant.InvalidInput.selector, "not swapper"));
        swapContract.cancelSwap(swapId);
    }
    ...
    function testCancelSwap_FailsIfAlreadyMatched() public {
        ...
        vm.prank(swapper);
        vm.expectRevert(abi.encodeWithSelector(openSwapOPGrant.InvalidInput.selector, "already matched"));
        swapContract.cancelSwap(swapId);
    }
    ...
    function testCancelSwap_FailsIfAlreadyCancelled() public {
        ...
        vm.prank(swapper);
        vm.expectRevert(abi.encodeWithSelector(openSwapOPGrant.InvalidInput.selector, "cancelled"));
        swapContract.cancelSwap(swapId);
    }
    ...
    function testBailOut_FailsIfNotMatched() public {
        ...
        vm.prank(randomUser);
        vm.expectRevert(abi.encodeWithSelector(openSwapOPGrant.InvalidInput.selector, "not matched"));
        swapContract.bailOut(swapId);
    }
    ...
    function testBailOut_FailsIfFinished() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(openSwapOPGrant.InvalidInput.selector, "finished"));
        swapContract.bailOut(swapId);
    }
    ...
    function testBailOut_NoOpIfLatencyNotReached() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(openSwapOPGrant.InvalidInput.selector, "can't bail out yet"));
        swapContract.bailOut(swapId);
    ...
    function testBailOut_OracleDistributedButCallbackFails() public {
        ...
        vm.mockCallRevert(
            ...
            abi.encodeWithSelector(openSwapOPGrant.onSettle.selector),
            "callback failed"
        );
        ...
        openSwapOPGrant.Swap memory sFinal = swapContract.getSwap(swapId);
    ...
    function testBailOut_ExactLatencyBoundary() public {
        ...
        openSwapOPGrant.Swap memory sMid = swapContract.getSwap(swapId);
    ...
    function testCancelSwap_EmitsEvent() public {
        ...
        emit openSwapOPGrant.SwapCancelled(swapId);
        swapContract.cancelSwap(swapId);
    }
