...
contract OpenSwapOnSettleTest is Test {
    ...
    function testOnSettle_OnlyOracleCanCall() public {
        ...
        vm.prank(randomUser);
        vm.expectRevert(abi.encodeWithSelector(openSwapOPGrant.InvalidInput.selector, "invalid sender"));
    ...
    function testOnSettle_WrongReportIdReverts() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(openSwapOPGrant.InvalidInput.selector, "wrong reportId"));
    ...
    function testOnSettle_OnlyAffectsMatchingSwap() public {
        ...
        openSwapOPGrant.Swap memory s1After = swapContract.getSwap(swapId1);
        openSwapOPGrant.Swap memory s2After = swapContract.getSwap(swapId2);
