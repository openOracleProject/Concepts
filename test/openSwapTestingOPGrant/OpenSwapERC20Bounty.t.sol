...
contract OpenSwapERC20BountyTest is Test {
    ...
    function testERC20Bounty_SwapCreation_WrongMsgValue_Reverts() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(openSwapOPGrant.InvalidInput.selector, "msg.value wrong"));
    ...
    function testERC20Bounty_MultipleSwapsIndependent() public {
        ...
        openSwapOPGrant.BountyParams memory bountyParams2 = openSwapOPGrant.BountyParams({
