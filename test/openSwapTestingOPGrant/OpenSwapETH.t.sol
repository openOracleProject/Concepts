...
contract OpenSwapETHTest is Test {
    ...
    function _getFulfillFeeParams() internal pure returns (openSwapOPGrant.FulfillFeeParams memory) {
    ...
    function testETHToToken_WrongMsgValue_Reverts() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(openSwapOPGrant.InvalidInput.selector, "msg.value vs sellAmt mismatch"));
    ...
    function testTokenToETH_MatchWrongMsgValue_Reverts() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(openSwapOPGrant.InvalidInput.selector, "msg.value"));
    ...
    function testTokenToToken_MatchWithETH_Reverts() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(openSwapOPGrant.InvalidInput.selector, "msg.value must be 0"));
